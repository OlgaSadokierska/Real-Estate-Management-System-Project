...
$query = "SELECT r.id AS Id, u.imie AS Imię, u.nazwisko AS Nazwisko, d.nazwa_domu AS 'Nazwa domu', d.opis 
AS Opis, d.metraz AS Metraż, d.cena AS Cena, r.data_rezerwacji AS 'Data rezerwacji' FROM rezerwacja r 
JOIN dom d ON r.ID_dom = d.id JOIN uzytkownik u ON r.ID_uzytkownik = u.id WHERE r.ID_uzytkownik = '$userID'";
